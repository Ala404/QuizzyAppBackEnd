...
urlpatterns = [
    ...
    path('quizzes/<int:pk>/questions/<str:difficulty>/', views.QuestionDifficultyView.as_view(), name='question-diff-list'),
    path('quiz/<int:pk>/answers/', views.QuizAnswersView.as_view(), name='question-answer-list'),
